...
return [
    ...
    'mobilyws' => [
        'username'    => env('MOBILYWS_USERNAME', 'Your Username'),
        'password'    => env('MOBILYWS_PASSWORD', 'Your Password'),
    ],

    'smsgw' => [
        'username'    => env('SMSGW_USERNAME', 'Your Username'),
        'password'    => env('SMSGW_PASSWORD', 'Your Password'),
    ],
];
